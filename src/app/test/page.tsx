        ...
        <div className="border p-5 rounded-md border-kiwi-border-table">
          ...
          <span className="text-[20px] text-white/12 mx-1">//</span>
           <p className="text-[13px] text-white/35 max-w-[380px] leading-relaxed">
            Open-source components, blocks & AI agents built on shadcn/ui.
          </p>
           <div className="ml-auto flex gap-2 shrink-0">
            <button className="text-[12px] px-3.5 py-1.5 rounded-md border border-white/10 text-white/50 bg-transparent hover:text-white hover:border-white/20 transition-all cursor-pointer">
              Figma Files
            </button>
            <button className="text-[12px] px-3.5 py-1.5 rounded-md border border-white/10 bg-white/7 text-white/75 hover:bg-white/11 transition-all cursor-pointer">
              View Components
            </button>
          </div>
        </div>
